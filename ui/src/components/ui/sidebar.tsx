...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("bg-sidebar-border mx-1.5 w-auto", className)}
      {...props}
    />
  );
}
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden scrollbar-hide group-data-[collapsible=icon]:overflow-y-auto group-data-[collapsible=icon]:overflow-x-hidden",
        className
      )}
      {...props}
    />
