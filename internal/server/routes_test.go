...
func TestDesktopPreferenceAndSettingRoutesExist(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{http.MethodGet, "/api/v1/preferences/appearance"},
		{http.MethodPut, "/api/v1/preferences/appearance"},
		{http.MethodGet, "/api/v1/preferences/viewer"},
		{http.MethodPut, "/api/v1/preferences/viewer"},
		{http.MethodGet, "/api/v1/preferences/workspace"},
		{http.MethodPut, "/api/v1/preferences/workspace"},
		{http.MethodGet, "/api/v1/preferences/resource-table"},
		{http.MethodPut, "/api/v1/preferences/resource-table"},
		{http.MethodGet, "/api/v1/preferences/ui"},
		{http.MethodPut, "/api/v1/preferences/ui"},
