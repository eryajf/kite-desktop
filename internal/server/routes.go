...
func registerDesktopPreferenceRoutes(r *gin.RouterGroup) {
	...
	preferenceAPI.GET("/appearance", handlers.GetAppearancePreference)
	preferenceAPI.PUT("/appearance", handlers.SaveAppearancePreference)
	preferenceAPI.GET("/viewer", handlers.GetViewerPreference)
	preferenceAPI.PUT("/viewer", handlers.SaveViewerPreference)
	preferenceAPI.GET("/workspace", handlers.GetWorkspacePreference)
	preferenceAPI.PUT("/workspace", handlers.SaveWorkspacePreference)
	preferenceAPI.GET("/resource-table", handlers.GetResourceTablePreference)
	preferenceAPI.PUT("/resource-table", handlers.SaveResourceTablePreference)
	preferenceAPI.GET("/ui", handlers.GetUIPreference)
	preferenceAPI.PUT("/ui", handlers.SaveUIPreference)
